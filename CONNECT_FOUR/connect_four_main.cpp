...
void SimpleTest()
{
	...
	b.insert(0, true);
	std::cout << "Second handout figure" << std::endl
			  << b << std::endl;
	...
	std::cout << "Third handout figure" << std::endl
			  << b;
	...
	b.insert(1, false);
	b.insert(1, true);
	std::cout << "Fourth handout figure" << std::endl
			  << b;
	std::cout << "Dimensions are " << b.numRows() << " X " << b.numColumns()
			  << std::endl
			  << std::endl;
	...
	b.insert(4, true);
	std::cout << "Fifth handout figure" << std::endl
			  << b;
	std::cout << "Dimensions are " << b.numRows() << " X " << b.numColumns()
			  << std::endl
			  << std::endl;
	...
	std::cout << "Board is now" << std::endl
			  << b2 << std::endl;
...
void StudentTest()
{
	Board b("PLAYER1", "PLAYER2", "XXXXXXX");
	...
	std::cout << "Dimensions are " << b.numRows() << " X " << b.numColumns()
			  ...
			  << std::endl;
	b.clear();
	std::cout << "Sixth handout figure" << std::endl
			  << b;
	std::cout << "Dimensions are " << b.numRows() << " X " << b.numColumns()
			  << std::endl
			  << std::endl;
